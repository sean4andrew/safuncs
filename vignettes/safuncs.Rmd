...
You can also specify tank-specific starting fish numbers by using a dataframe as input to `starting_fish_count`!
```{r, eval = FALSE}
...
With such a short R script, you can now quickly regenerate survival data whenever there is a slight change in the mort database; perhaps from day-to-day or after corrections. For those wanting to use the survival data in prism, specify `output_prism = TRUE` to get a prism-ready csv. saved in your working directory.

###################################################################
[Sean is procrastinating! Remind him to get this documentation done..]
