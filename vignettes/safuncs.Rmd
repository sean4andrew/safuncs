...
```
The plots save automatically to your working directory as a .tiff and a power-point editable plot (as .pptx). Notably, `Surv_Plots()` accepts many more arguments that can influence the hazard plot in particular and needs tailoring for your specific experiment. For more details on these arguments, please see its [documentation page](https://sean4andrew.github.io/safuncs/reference/Surv_Plots.html).
