...
MultiVar(multivar_db = multivar_db_ex,
         ...
         pca_labels = "none") # A character string describing the labels to add to all 'existing' PCA plots (as determined by prior arguments). Choose any number from "var" and "ind" which refers to xxx, respectively.
```
