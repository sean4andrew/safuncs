...
animal = "Fish"
animal_numbers = 1:4 #for all arguments, specify as vector and match with trt_tank_id.
...
Function
```{r}
v_vec = c("study_id", "timepoint", "trt_tank_id", "animal", "animal_numbers", "tissue", "repli")
