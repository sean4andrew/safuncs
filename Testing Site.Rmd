...
2. Load dataset
```{r Setup data}
QCATC1092_DB = read.csv(file = "ONDA1092-4 Gene R Ready Format.csv")[-97,]
QCATC1092_DB$Month = factor(QCATC1092_DB$Month, levels = c("May", "Jun", "Jul", "Oct", "Nov", "Dec")) # reordering levels
```
...
```{r Run MultiVar()}
output_ex3 = MultiVar(multivar_db = QCATC1092_DB,
         values_cols = 4:6,
         factors_cols = 1:2,
         factors_facet = c("col1", "col2"),
         ...
         boxplot_var_sep = TRUE,
         #boxplot_x_wrap = 4,
         boxplot_points = FALSE,
         boxplot_outliers = TRUE,
         plot_out_R = TRUE)$box$facet1$`NKAa1b LogRQ`
```
